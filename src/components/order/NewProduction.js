    ...
    return(
        <div className="wrap-summery pb-3 overflow-hidden">
            <div className= "d-flex p-3 rounded-0 border border-ligth justify-content-between align-items-center">
                ...
                <ul className="d-flex">
                    <li><Link to={link} className="btn btn-primary fs-5">{btnTitle}</Link></li>
                </ul>
            </div>
            <div className="p-3">
            <div className="row">
            ...
            <ul className="d-flex gap-2 justify-content-center ">
                <li><button className="btn px-5 fs-4 btn-outline-secondary">Cancle</button></li>
                <li><button className="btn px-5 fs-4 btn-primary">Save</button></li>
            </ul>
        </div>
            </div>
    )
