...
function SMSSettings () {
    ...
    return(
        ...
        <div className='table-responsive active-projects style-1'>
            <h2 className='tbl-caption text-light'>SMS Settings List
            <Link className="btn btn-primary btn-sm"  to="/sms-settings/new-sms" role="button" aria-controls="offcanvasExample">
            + New SMS Settings</Link></h2>
