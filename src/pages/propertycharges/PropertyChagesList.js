...
import {getCrePropertyChages, propertycahgerDelte} from '../../api/login/Login'
import Loadar from '../../common/loader/Loader'
import PropertyCharges from '.'

function PropertyChargesList() {
    ...
    const getPaginationApi = async (page) => {
        // setLoading(true)
        try {
            const res = await getCrePropertyChages(1 , 100)
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption">
                                    <h4 className="heading mb-0">Property Charges</h4>
                                    <div>
                                        <Link className="btn btn-primary btn-sm" to="/newpropertycharges" role="button" aria-controls="offcanvasExample">+ New Property Chages</Link>
                                            ...
                                            return <tr role="row" className="odd" key={item?._id}>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        <Link to={`/newpropertycharges/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1"><i className="fa fa-pencil" /></Link>
                                                        <Popconfirm
...
export default PropertyChargesList
