    ...
    <div className="card" style={{ marginTop: "10px", marginLeft: "4px", marginRight: "4px" }}>
      <div className="table-responsive active-projects style-1">
        <div className='tbl-caption text-light' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
           <h3 className="" style={{ color: 'white' }}>Data Ploicy</h3>
         <div>
            <Link className="btn btn-primary btn-sm" to="/newdatapolicyform" role="button" aria-controls="offcanvasExample">
              + Data Policy Added
            </Link>
