...
function FrequnceyTemplateList() {
  return (
    <div>
      <div className='card'style={{marginTop: "10px", marginLeft: "4px", marginRight: "4px"}}>
    <div className='table-responsive active-projects style-1' >
        <h3 className='tbl-caption text-light'>
        Frequncey Templates List
        <Link className="btn btn-primary btn-sm" to="/frequnceyform"
         role="button" aria-controls="offcanvasExample">+ New 
Frequncey Templates Added</Link></h3>
...
export default FrequnceyTemplateList
