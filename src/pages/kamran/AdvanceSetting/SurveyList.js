...
function SurveyList() {
  return (
    ...
    <div className='table-responsive active-projects style-1' >
      <h3 className='tbl-caption text-light'>Survey List 
  <Link className="btn btn-primary btn-sm" to="/surveyform"
   role="button" aria-controls="offcanvasExample">+ New Survey List Added</Link></h3>
     </div>
    <div className="mt-3">
