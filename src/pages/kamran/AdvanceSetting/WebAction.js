...
function WebAction() {
  return (
    ...
    <div className='table-responsive active-projects style-1' >
        <h3 className='tbl-caption text-light'>Web Action 
        <Link className="btn btn-primary btn-sm" to="/webactionform"
         role="button" aria-controls="offcanvasExample">+ New Web Action Added</Link></h3>
    </div>
    <div className="mt-3">
