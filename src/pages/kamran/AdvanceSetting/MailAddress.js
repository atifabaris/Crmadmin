...
function MailAddress() {
  return (
    ...
    <div className='table-responsive active-projects style-1' >
        <h3 className='tbl-caption text-light'>Organization Mail Address
        <Link className="btn btn-primary btn-sm" to="/newmailaddress"
         role="button" aria-controls="offcanvasExample">+ New Mail Address Added</Link></h3>
    </div>
    <div className="mt-3">
