...
function ExternalReport() {
  return (
    ...
    <div className='table-responsive active-projects style-1' >
      <h3 className='tbl-caption text-light'>External Report List 
  <Link className="btn btn-primary btn-sm" to="/externalreportform"
   role="button" aria-controls="offcanvasExample">+ New Report Added</Link></h3>
