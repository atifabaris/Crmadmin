...
function NewSurveyAss() {
  return (
    <div className='card' style={{ marginTop: "10px", marginLeft: "4px", marginRight: "4px" }}>
    <div className='table-responsive active-projects style-1' >
      <h3 className='tbl-caption text-light'>Survey Assigment List 
  <Link className="btn btn-primary btn-sm" to="/newsurveyassform"
   role="button" aria-controls="offcanvasExample">+ New Survey Assigment Added</Link></h3>
     </div>
    <div className="mt-3">
