  ...
  return (
    <div className='card'style={{marginTop: "10px", marginLeft: "4px", marginRight: "4px"}}>
        <div className='table-responsive active-projects style-1' >
            <h3 className='tbl-caption text-light'>Payment Config 
            <Link className="btn btn-primary btn-sm" to="/newpayment"
             role="button" aria-controls="offcanvasExample">+ New Payment Added</Link></h3>
